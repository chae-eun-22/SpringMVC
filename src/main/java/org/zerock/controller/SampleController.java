...
public class SampleController {
	...
	public void basic() {
		...
		// 리턴이 void이므로: 파일 [/WEB-INF/views/sample.jsp]을(를) 찾을 수 없습니다.
	...
	public String ex02(@RequestParam("owner") String name, @RequestParam("age") int age) {
		// 프론트 변수와 백엔드의 변수가 다를 때(초보자는 일치 시킬 것)
	...
	public String ex04(SampleDTO dto, int page) { // int page는 게시판에 페이징기법 예시
	...
	public ResponseEntity<String> ex07() {
		// ResponseEntity<String> 응답 헤더(200 ok, 404, 304)
		...
		// msg에는 json 데이터 / header에는 json 타입 / 상태값은 ok
	}
}
